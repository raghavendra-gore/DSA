...
This project provides a solution to merge all overlapping intervals from a given collection of intervals. The input intervals are provided in a 2-D array format and are sorted by their start values.
